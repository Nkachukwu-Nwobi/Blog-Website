  ...
  return (
    <nav className=" bg-black drop-shadow-xl w-full flex flex-col gap-10 py-10 mt-20">
      ...
      <div className='flex gap-20 px-16 py-14 w-10/12 mx-auto bg-darkgrey bg-opacity-[20%]'>
        ...
        <h3 className=' w-[50%] text-light'>Subscribe to our news letter to get latest updates and news</h3>

        <div className='w-[50%] flex justify-between items-center gap-4'>
          <input type="text" placeholder='Enter your Email' className=' px-4 py-2 text-light bg-darkgrey bg-opacity-[20%] border border-midgrey w-[65%]' />
      ...
      <div className=' w-10/12 mx-auto flex justify-between items-center'>
        ...
        <div className="flex flex-col sm:flex-row gap-3 text-xl text-midgrey">
            ...
            <Link
              href={'https://github.com/Nkachukwu-Nwobi?action=show&controller=profiles&tab=contributions&user_id=Nkachukwu-Nwobi'}
              className="text-white no-underline  hover:text-white flex "
            >
            <FaGithub />
            </Link>
